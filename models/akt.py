...
from .modules import AKTTransformerLayer,CosinePositionalEmbedding
...
class AKT(Module):
    def __init__(self, device,  num_skills, num_questions, seq_len, bincounts,
                 ...
                 final_fc_dim=512, d_ff=2048, l2=1e-5, dropout=0.2, separate_qr=False):
    ...
    def forward(self, feed_dict):
        ...
        if self.num_questions > 0:
            ...
            if self.de.startswith(("sde", "random", "alibi-sde", "rotary-sde")):
                ...
                if self.de.startswith("basic"): #basic 的语义是没有位置编码
